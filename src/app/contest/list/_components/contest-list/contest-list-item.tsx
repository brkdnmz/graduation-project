  ...
  return (
    <li>
      <Link
        ...
        className="block space-y-5 rounded-xl bg-slate-800 p-4 text-slate-300 transition-all duration-200 hover:brightness-125"
      >
        <div className="space-y-2">
          <div className="flex items-end gap-1">
            <h2 className="font-bold">{contest.name}</h2>
            <h5 className="pl-1 text-sm text-muted-foreground">
              {contest.type}
            </h5>
          </div>
